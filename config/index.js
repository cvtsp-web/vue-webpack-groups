...
const selfDirectory = path.resolve(__dirname);
...
module.exports = {
  ...
  build: {
    ...
    index: resolveApp('dist/index.html'), //path.resolve(__dirname, '../dist/index.html'),

    // Paths
    assetsRoot: resolveApp('dist'), //path.resolve(__dirname, '../dist'),
    assetsSubDirectory: 'static',
    assetsPublicPath: '/',
